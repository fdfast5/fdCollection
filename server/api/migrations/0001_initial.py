# Generated by Django 3.2.12 on 2023-06-12 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file_name', models.FileField(null=True, upload_to='audio/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('twitch_reward_id', models.CharField(max_length=10)),
                ('image_file_name', models.ImageField(null=True, upload_to='image/')),
                ('valid_flag', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
            ],
